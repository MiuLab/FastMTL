...
cd ..
cp ./results/FINETUNE_${MODEL_NAME}_${POSTFIX}_${TASK_USE_ABS}_BEST/submission.zip $HTDOCS/submission/DEV_SCORE/${MODEL_NAME}_${POSTFIX}_${TASK_USE_ABS}_submission.zip
