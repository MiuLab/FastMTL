...
#Eval
./run_eval_finetune.sh $MODEL_NAME $POSTFIX $TASK_POSTFIX $BATCHSIZE $TOTAL_EPOCH $CUDA
wait
...
./run_predict_finetune.sh $MODEL_NAME $POSTFIX $TASK_POSTFIX $BATCHSIZE $TOTAL_EPOCH $CUDA
wait
#mv the test files
